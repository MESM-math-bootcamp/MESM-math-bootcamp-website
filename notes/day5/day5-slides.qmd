...
## {#integral-calc-1 data-menu-title="Integrals"}
...
## {#definite-blank data-menu-title="Definite vs Indefinite"}
...
![](images/twocurve.png){fig-align="center" width=90%}
:::
...
## {#exercises-title data-menu-title="Exercises" background-color="#003660"}

<div class="page-center">
<div class="custom-subtitle">Exercises</div>
</div>
...
::: {.column width="30%"}
C) Integrate $$\int^4_2\frac{1}{2}x$$
:::
...
## {#ta2-A-solution data-menu-title="Team Assessment 2 Questions" .smaller}
...
## {#exercises-2 data-menu-title="Exercises"}


[Exercises 2]{.slide-title}
...
## {#exercises-solution-2-blank data-menu-title="Exercise 2 solution" .smaller}
...
## {#exercises-solution-2 data-menu-title="Exercise 2 solution" .smaller}
...
## {#exercises-solution-3-blank data-menu-title="Exercise 2 solution"}
...
## {#exercises-solution-3-work data-menu-title="Exercise 2 solution"}
...
## {#exercises-solution-3 data-menu-title="Exercise 2 solution"}
...
✏️ [1. How would you check that $y(x) = -x -1$ is a solution for this differential equation?]{style="color:green;"}
...
[Use the terms from the previous slide to describe the following different equations:]{.body-text-m style="color:green;"}
...
- <span style="color:#E6007E"><b>🌊 A bit of ODEs</b></span>
