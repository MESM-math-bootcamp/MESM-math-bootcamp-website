---
author: "Adapted by C. Galaz García from work by Nathan Grimes."
---
...
4) Representative Concentration Pathwys (RCP) are climate chabge scenarios that project future greenhouse gas concentrations. 
A new [RCP 4.5 projection](https://en.wikipedia.org/wiki/Representative_Concentration_Pathway) indicates that carbon emissions in the atmosphere will plateau at around 600 ppm. Today's atmospheric carbon concentration sits at 416 ppm. 
    ...
    b) Let's say the US decides to pursue an ambitious policy to extract their contribution of carbon from the air. Climatologists model that this policy would have a trajectory of $f(c)=\frac{-1}{8}t^2+6t+123.83$ where $t$ is each year and $c$ is the amount of carbon released by the US. When will the United States eliminate their carbon footprint?
...
```
  ...
  ![Picture of scalloped hammerhead shark.](images/scalloped_hammerhead_shark.jpg)
