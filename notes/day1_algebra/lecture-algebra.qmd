...
*Mterials have been adapted and expanded from Nathaniel Grimes work for the Bren Calculus Workshop.*
...
::: {.column width="40%"}
![](images/Carmen4.jpg){fig-align="center"}
...
Always add/substract/multiply/divide by the same number on both sides. More generally, always apply the same function to both sides of the qeuation. 
...
## {#flex-eq-2 data-menu-title="Often times we want flexible equations"}
...
✏️ [Take three minutes to solve these individually.]{style="color:green;"}
