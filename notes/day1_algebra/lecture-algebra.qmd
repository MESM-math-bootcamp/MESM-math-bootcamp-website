...
<!-- Source: ESM 201 Exercise Bank, Exercise 3 -->
## {#population-growth-practice data-menu-title="Population growth: practice"}

[Solving a growth-rate equation]{.slide-title}

<hr>

✏️ [Take a minute to solve this individually.]{style="color:green;" .body-text-m}

<br>

The logistic per-capita growth rate is

$$
r\left(1-\frac{N}{K}\right)
$$

where $N$ is population size, $K$ is the carrying capacity, and $r$ is the intrinsic growth rate.

<br>

If this rate equals $0.02$ when $N=750$ and $K=1000$, solve for $r$.

---

## {#population-growth-solution data-menu-title="Population growth: space to solve"}
...
$$
r\left(1-\frac{N}{K}\right) = 0.02, \quad N=750,\ K=1000
$$

---

## {#population-growth-answer data-menu-title="Population growth: solution"}
...
<!-- Source: ESM 202 Exercise Bank, Exercise 6 -->
## {#concentration-balance-practice data-menu-title="Concentration balance: practice"}

[Solving a concentration balance]{.slide-title}
...
A steady-state concentration balance for a pollutant in a mixed system is

$$
3(C-5)+2C=40 \quad \text{(mg/L)}
$$

where $C$ is the pollutant concentration. Solve for $C$.

---

## {#concentration-balance-solution data-menu-title="Concentration balance: space to solve"}
...
## {#concentration-balance-answer data-menu-title="Concentration balance: solution"}
...
<!-- Source: ESM 203 Exercise Bank, Exercise 9 -->
## {#water-balance-practice data-menu-title="Water balance: practice"}

[Solving for precipitation]{.slide-title}
...
A watershed's water balance is:

:::{.center-text}
Change in storage per unit time = Precipitation − Actual ET − River outflows
:::

<br>

Suppose the watershed is at **steady state** (storage isn't changing), actual evapotranspiration ($AET$) is 60% of precipitation ($P$), and river outflow is $Q = 320$ mm/y.
...
## {#water-balance-solution data-menu-title="Water balance: space to solve"}
...
Steady state, $AET = 0.6P$, $Q = 320$ mm/y.

---

## {#water-balance-answer data-menu-title="Water balance: solution"}
...
$$
\begin{aligned}
\text{change in storage} &= P - AET - Q \\
\text{steady state} \Rightarrow 0 &= P - AET - Q \\
AET &= 0.6P \\
0 &= P - 0.6P - Q \\
0.4P &= Q = 320 \\
P &= 800 \text{ mm/y}
