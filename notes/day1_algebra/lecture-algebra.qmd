...
1. Convert 3,400 mm to meters.

<br>

2. Convert an area of $3.2 \text{ km}^2$ to $\text{m}^2$.

<br>


3. A stock solution is 4 g/L. Express this in mg/mL.

<br>

4. Convert $8.1\frac{km}{s}$ to miles per hour, given that 1 km = 0.621 miles.

<br>

5. A lake has average depth 800 cm and surface area $2.5 \text{ km}^2$. Using Volume = depth × area, find the volume in $\text{m}^3$.
:::
...
## {#unit-conv-solutions-2 data-menu-title="Unit conversions practice"}
...
[**1.** $3{,}400 \text{ mm} = 3{,}400 / 10^3 = 3.4$ m]{.body-text-m}

<br>

[**2.** $3.2 \text{ km}^2 \times (1000\text{ m/km})^2 = 3.2\times10^{6}$ m²]{.body-text-m}

<br>

[**3.** $4 \text{ g/L} = 4000 \text{ mg} / 1000 \text{ mL} = 4$ mg/mL]{.body-text-m}

<br>

[**4.** $8.1\frac{km}{s} \times 3600\frac{s}{hr} \times 0.621\frac{mi}{km} = 18108.36 \frac{mi}{hr}$]{.body-text-m}

<br>

[**5.** Area $= 2.5\times10^{6}$ m². Volume $= 8 \times 2.5\times10^{6} = 2\times10^{7}$ m³]{.body-text-m}
