...
(2) Any non-negative $x$ to the power of 0 equals 1:

$$x^0 = 1, \ \ \text{for } x \neq 0$$ 

(3) Negative exponent means divide:

$$ x^{-a} = \frac{1}{x^a}, \ \ \text{for } x \neq 0$$

(4) Fractional exponent means take the $n$-th root:
...
(5) Power of a power means multiply the exponents:

$$(x^a)^b = x^{ab}$$

(6) Exponents get distributed over products:

$$ (xy)^a = x^a y^a$$

(7) And exponents get distributed over divisions:

$$ \left( \frac{x}{y} \right)^a = \frac{x^a}{y^a} $$

(8) If $a$ is the $n$-th root of $x$, then $a$ to the $n$ equals x
...
#knitr::include_graphics("images/ireland.png")
```
