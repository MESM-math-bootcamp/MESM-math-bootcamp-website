...
[Differential Equations and Numerical Calculus]{.custom-title}
...
[Lotka-Volterra models](https://en.wikipedia.org/wiki/Lotka–Volterra_equations) to describe predator prey dynamics:
$$
\begin{align}
...
where $N_1, N_2$ are the population of prey and preadtor respectively.
:::
