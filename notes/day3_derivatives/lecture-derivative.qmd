...
## {#exponent data-menu-title="The number $e$ and exponential funcitons"}
...
## {#higher-order-der-meme data-menu-title="Higher Order Derivatives"}
...
✏️ [Identify which rule or rules works best for each function.]{style="color:green;"}
...
✏️ [Answer the following questions using the Dochy et al. model.]{style="color:green;"}
...
A function is **increasing** on an interval $(a,b)$ is $f(x_1) \leq f(x_2)$ every time $x_1<x_2$. 

A function is **decreasing** on an interval $(a,b)$ is $f(x_1) \geq f(x_2)$ every time $x_1<x_2$. 
...
<div class="page-center">
![](images/Maxima_and_Minima.svg.png)
</div>
...
- Whether an extremum is a maximum or minimum requires us to test if the function is concave up  or concave down around that point. 
...
<div class="page-center">
![](images/concavity-second-derivative.gif)
</div>
...
## {#opt-graph data-menu-title="Example"}

[Example]{.slide-title}

<hr>

✏️ [Consider the function  $f(x)=x^3-12x+2$. What are its local maxima and minima?]{style="color:green;"}
...
✏️ [1. How many local min and maximums can you find on this graph?]{style="color:green;"}
...
✏️ [2. Find all the critical values. Identify which are minima and which are maxima.]{style="color:green;"}
...
## {#solutions data-menu-title="Solutions"}
