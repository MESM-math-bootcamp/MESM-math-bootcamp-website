...
[Rules and Applications of Derivatives]{.custom-title}
...
```
<!--fig.cap="Figure 2 from Dochy 2015",-->
:::
:::{.column width="50%"}
...
✏️ [1. How many local minimums and maximums can you find on this graph?]{style="color:green;"}
...
## {#gta2-2-blank data-menu-title="Team Assessment 2 Questions"}

✏️ [2. Find all the critical points of this function. Identify which are minima and which are maxima.]{style="color:green;"}
[
$$
f(x)=2x^3-6x^2+3x+15
$$]{style="color:green;"}
