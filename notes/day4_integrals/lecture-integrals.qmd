...
::: {.column width="50%"}
![](images/riemann.gif){fig-align="center" width="220%"}
:::
...
[But also itegration can be tough]{.slide-title}
...
::: {.column width="60%"}
![Source [xkcd comics](https://xkcd.com/2117/)](images/xkcd.png)
:::
...
## {#notation-blank data-menu-title="Notation"}
...
## {#definte-1 data-menu-title="Definite vs Indefinite"}

[Indefinite vs. dfinite integrals]{.slide-title}

<hr>
- We have been working with **indefinite integrals**: there are no integration bounds

$$
\int f(x)dx
$$

- We need initial values to find integration constants.
...
![](images/diffxtwo.gif){fig-align="center" width="50%"}
