...
axis(1, at = seq(x_min, x_max, by = 1), cex.axis = 2)
axis(2, at = seq(y_min, y_max, by = 1), cex.axis = 2)
```
...
## {#applications-2 data-menu-title="Applications" background-color="#003660"}
...
## {#supply-demand-practice data-menu-title="Supply and demand: practice"}

[Supply and demand]{.slide-title}
...
## {#supply-demand-sol-1 data-menu-title="Supply and demand: practice"}
...
## {#supply-demand-sol-3 data-menu-title="Supply and demand: practice"}
...
## {#supply-demand-sol-4 data-menu-title="Supply and demand: practice"}
...
## {#supply-demand-solutions-summary data-menu-title="Supply and demand: solutions" .smaller}
...
## {#supply-demand-concept data-menu-title="Supply and demand"}
...
::: {.body-text-m}
- The **supply curve** $S(Q)$ shows the price producers must receive to be willing to supply each quantity $Q$ — it slopes **upward**.

- The **demand curve** $D(Q)$ shows the price buyers are willing to pay for each quantity $Q$ — it slopes **downward**.

- The point where the two curves **intersect** is the **market equilibrium**: the price and quantity at which the amount supplied equals the amount demanded, so the market clears.
::: -->

---

## {#supply-demand-solutions-2 data-menu-title="Supply and demand: solutions" .smaller}

[Solutions]{.slide-title}

<hr>

(3) $S(Q)$ and $D(Q)$ plotted together:

```{r fig.align='center', out.width="55%"}
Q <- seq(0, 160, length.out = 200)
S <- 20 + 0.5*Q
D <- 90 - 0.5*Q

par(mar = c(5, 6, 2, 2))

plot(Q, S, type = "l", lwd = 4, col = "darkgreen",
     xlim = c(0, 160), ylim = c(0, 100),
     xlab = "Q (thousand lbs/week)", ylab = "P ($/lb)",
     cex.lab = 2, cex.axis = 2)

lines(Q, D, lwd = 4, col = "steelblue")

Q_star <- 70
P_star <- 55

segments(Q_star, 0, Q_star, P_star, lty = 3, col = "gray50")
segments(0, P_star, Q_star, P_star, lty = 3, col = "gray50")
points(Q_star, P_star, pch = 19, cex = 1.8, col = "black")

legend("right", legend = c("Supply S(Q)", "Demand D(Q)"),
       col = c("darkgreen", "steelblue"), lwd = 4, bty = "n", cex = 2)
```
...
- <span style="color:#EDC001"><b>📈 $x$ and $y$ intercepts</b></span>
...
## {#extra data-menu-title="Extra" background-color="#003660"}

<div class="page-center">
<div class="custom-subtitle">Logistic growth (extra)</div>
</div>
